...
Start XAMPP and run both Apache & MySQL.
Import smart_queue.sql in phpMyAdmin to create the database and table.
Run RegisterForm.java or LoginForm.java from the ui package to launch the application.
===============================================================================
...
Create database smart_queue_system and import smart_queue_schema.sql
Open the project in IntelliJ IDEA
Run RegisterForm.java to create user or admin
Then run LoginForm.java to log in and use system
Notes:
